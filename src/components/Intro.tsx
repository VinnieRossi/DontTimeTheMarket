...
const Intro = (): JSX.Element => {
  return (
    ...
    //   <div classNameNameName="container mx-auto p-4">
    //     <h1 classNameNameName="text-4xl pb-4 font-semibold">Don't time the market!</h1>
    //     <h2 classNameNameName="text-2x1 pb-4">And other things to know</h2>
    //   </div>

    //   <div classNameNameName="bg-gray-100">
    //     <div classNameNameName="container grid grid-cols-2 grid-rows-2 mx-auto p-4">
